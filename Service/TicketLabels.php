...
class TicketLabels
{
    private const LABELS = [
        'source' => [
            ...
            'screenshots_attached' => '%d Screenshot(s) übermittelt, siehe Anhänge am Ticket.',
            'modules_omitted' => 'Modulliste wegen Größenbegrenzung ausgelassen.',
            'ai_omitted' => 'KI-Aufbereitung wegen Größenbegrenzung ausgelassen.',
        ...
        'en' => [
            ...
            'screenshots_attached' => '%d screenshot(s) submitted, see the attachments on this ticket.',
            'modules_omitted' => 'Module list omitted due to size limit.',
            'ai_omitted' => 'AI summary omitted due to size limit.',
